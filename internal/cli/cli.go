...
func PrintUsage() {
	...
	fmt.Println("  tool pnpm_add             Add one or more packages using pnpm (preferred) or npm")
	fmt.Println("  tool pnpm_pm2             Manage Node.js processes with PM2 (supports custom flags)")
	fmt.Println()
